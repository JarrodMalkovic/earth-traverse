...
@Component({
    ...
    template: `
        ...
        <h1 class="text-center font-extrabold text-3xl  leading-9 tracking-tight mt-4 text-white" >Sign up for an account</h1>
</div>
        ...
        <h2 class="text-center text-slate-300 mt-8" > Already have an account? <a class="text-violet-400"> Sign in </a> </h2>
  `,
