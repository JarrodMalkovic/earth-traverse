          ...
          <app-progress-bar [size]="'sm'"  [percentageComplete]="0.5"></app-progress-bar>
            ...
            <div class="relative ml-3">
              <div class="flex space-x-2 w-full">
                ...
                <button type="button" class="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-violet-300 focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
