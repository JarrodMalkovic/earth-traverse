...
@Component({
    ...
    template: `
        ...
        <div class="mt-10">
        <img class="mx-auto h-10 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=violet&shade=300" alt="Your Company">
        <h1 class="text-center font-extrabold text-3xl  leading-9 tracking-tight mt-4 text-white" >Sign in to your account</h1>
</div>


        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
            <div class="backdrop-blur-lg bg-white/10 p-12 rounded-xl shadow-xl bg-opacity-10 ">
            <form class="space-y-6" action="#" method="POST">
                <div>
                    <label for="email" class="block text-sm font-medium leading-6 text-white">Username</label>
                    <div class="mt-2">
                        <input id="email" name="email" type="email" autocomplete="email" required class="text-white block w-full focus:border-violet-400 focus:ring-violet-400 focus:outline-none focus:ring-1 rounded-md py-1.5 bg-slate-900/25 ring-0 background-blur border-white/20 border-2 bg-opacity-50 background-blur sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="flex justify-center items-center mt-10">
                    ...
                    <div class="mx-4 min-w-fit text-white text-sm font-medium">Or continue with</div>
                    <hr class="h-0.5 w-full border-0 bg-white/20 opacity-90 ">
                </div>
</div>
        ...
        <h2 class="text-center text-slate-300 mt-8" > Dont have an account? <a class="text-violet-400"> Sign up today </a> </h2>
  `,
